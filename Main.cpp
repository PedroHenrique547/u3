...
void Main::menuGestaoViagens() {
    ...
    while (true) {
        ...
        cout << "3. Registrar a partida de transporte (INATIVO)\n";
        cout << "4. Avancar X horas e atualizar estado do sistema(INATIVO)\n";
...
void Main::menuListagens() {
    int opcao;
    while (true) {
        cout << "\n=== MENU DE CONSULTAS E RELATORIOS ===\n";
        cout << "1. Relatorio de onde estao cada passageiros\n"; //(cidade ou em trânsito, informando origem-destino-transporte)
        cout << "2. Relatorio de onde esta cada transporte\n";
        cout << "3. Relatorio de todas as viagens em andamento\n";
        cout << "4. Relatorio das cidades mais visitadas\n";
        cout << "0. Voltar ao Menu Principal\n";
        cout << "Escolha: ";
        cin >> opcao;
